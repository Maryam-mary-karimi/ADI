...
#"permission:yes,merit:low,affordability:some,lifetime:long,Update:yes,latency tolerance:high,trust:high,redundancy:yes" 
    msg1=self.msg[u'msg']
    print msg1
    msg2=msg1.split(",")
    print(msg2[0])
    permission=msg2[0].split(":")[1]
    merit=msg2[1].split(":")[1]
    afford=msg2[2].split(":")[1]
    lifetime=msg2[3].split(":")[1]
    update=msg2[4].split(":")[1]
    late=msg2[5].split(":")[1]
    trust=msg2[6].split(":")[1]
    redund=msg2[7].split(":")[1]
